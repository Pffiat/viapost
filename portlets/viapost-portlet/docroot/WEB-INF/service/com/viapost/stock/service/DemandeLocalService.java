...
/**
 * Provides the local service interface for Demande. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pif
 * @see DemandeLocalServiceUtil
...
public interface DemandeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DemandeLocalServiceUtil} to access the demande local service. Add custom service methods to {@link com.viapost.stock.service.impl.DemandeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
