...
/**
 * Provides the local service interface for UserDemande. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pif
 * @see UserDemandeLocalServiceUtil
...
public interface UserDemandeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserDemandeLocalServiceUtil} to access the user demande local service. Add custom service methods to {@link com.viapost.stock.service.impl.UserDemandeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
