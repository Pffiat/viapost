...
import com.viapost.stock.service.ProductLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.viapost.stock.service.impl.ProductLocalServiceImpl}.
 * </p>
 *
 * @author pif
...
public abstract class ProductLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.viapost.stock.service.ProductLocalServiceUtil} to access the product local service.
	 */
	 ...
	 */
	@Override
	public Product createProduct(long stockId) {
		return productPersistence.create(stockId);
	}
	...
	@Override
	public Product deleteProduct(long stockId)
		throws PortalException, SystemException {
		return productPersistence.remove(stockId);
	}
	...
	@Override
	public Product fetchProduct(long stockId) throws SystemException {
		return productPersistence.fetchByPrimaryKey(stockId);
	}
	 ...
	 */
	@Override
	public Product getProduct(long stockId)
		throws PortalException, SystemException {
		return productPersistence.findByPrimaryKey(stockId);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.viapost.stock.model.Product",
			productLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.viapost.stock.model.Product");
	}
