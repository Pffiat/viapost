...
import com.viapost.stock.model.impl.ProductImpl;
import com.viapost.stock.model.impl.ProductModelImpl;
...
public class ProductPersistenceImpl extends BasePersistenceImpl<Product>
	 ...
	 */
	@Override
	public Product create(long stockId) {
		Product product = new ProductImpl();

		product.setNew(true);
		product.setPrimaryKey(stockId);
	 ...
	 */
	@Override
	public Product remove(long stockId)
	...
	@Override
	public Product updateImpl(com.viapost.stock.model.Product product)
	...
	protected Product toUnwrappedModel(Product product) {
		...
		productImpl.setStockId(product.getStockId());
		productImpl.setArticleNumber(product.getArticleNumber());
		productImpl.setStock(product.getStock());
		productImpl.setSeuil_stock(product.getSeuil_stock());
	 ...
	 */
	@Override
	public Product findByPrimaryKey(long stockId)
		throws NoSuchProductException, SystemException {
	 ...
	 */
	@Override
	public Product fetchByPrimaryKey(long stockId) throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.viapost.stock.model.Product")));
