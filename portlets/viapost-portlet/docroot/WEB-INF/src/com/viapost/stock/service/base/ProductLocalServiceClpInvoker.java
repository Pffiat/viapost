...
public class ProductLocalServiceClpInvoker {
	public ProductLocalServiceClpInvoker() {
		...
		_methodName50 = "addProductFromRequest";

		_methodParameterTypes50 = new String[] { "javax.portlet.ActionRequest" };

		_methodName51 = "editProductFromRequest";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return ProductLocalServiceUtil.addProduct((com.viapost.stock.model.Product)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return ProductLocalServiceUtil.deleteProduct((com.viapost.stock.model.Product)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return ProductLocalServiceUtil.updateProduct((com.viapost.stock.model.Product)arguments[0]);
		}
		...
		if (_methodName50.equals(name) &&
			...
			ProductLocalServiceUtil.addProductFromRequest((javax.portlet.ActionRequest)arguments[0]);
		...
		if (_methodName51.equals(name) &&
			...
			ProductLocalServiceUtil.editProductFromRequest((javax.portlet.ActionRequest)arguments[0]);
