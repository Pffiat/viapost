...
import com.meera.db.NoSuchFeedbackException;
import com.meera.db.model.Feedback;
import com.meera.db.model.impl.FeedbackImpl;
import com.meera.db.model.impl.FeedbackModelImpl;
...
public class FeedbackPersistenceImpl extends BasePersistenceImpl<Feedback>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_S = new FinderPath(FeedbackModelImpl.ENTITY_CACHE_ENABLED,
			...
			FeedbackModelImpl.GROUPID_COLUMN_BITMASK |
			FeedbackModelImpl.STATUS_COLUMN_BITMASK |
			FeedbackModelImpl.FEEDBACKDATE_COLUMN_BITMASK);
	 ...
	 */
	@Override
	public List<Feedback> findByG_S(long groupId, int status)
		throws SystemException {
	 ...
	 */
	@Override
	public List<Feedback> findByG_S(long groupId, int status, int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public List<Feedback> findByG_S(long groupId, int status, int start,
		int end, OrderByComparator orderByComparator) throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
	 ...
	 */
	@Override
	public Feedback findByG_S_First(long groupId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchFeedbackException, SystemException {
		Feedback feedback = fetchByG_S_First(groupId, status, orderByComparator);
	 ...
	 */
	@Override
	public Feedback fetchByG_S_First(long groupId, int status,
		OrderByComparator orderByComparator) throws SystemException {
		List<Feedback> list = findByG_S(groupId, status, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Feedback findByG_S_Last(long groupId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchFeedbackException, SystemException {
		Feedback feedback = fetchByG_S_Last(groupId, status, orderByComparator);
	 ...
	 */
	@Override
	public Feedback fetchByG_S_Last(long groupId, int status,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Feedback> list = findByG_S(groupId, status, count - 1, count,
				orderByComparator);
	...
	public Feedback[] findByG_S_PrevAndNext(long feedbackId, long groupId,
		...
		try {
			...
			array[0] = getByG_S_PrevAndNext(session, feedback, groupId, status,
					orderByComparator, true);

			array[1] = feedback;

			array[2] = getByG_S_PrevAndNext(session, feedback, groupId, status,
					orderByComparator, false);
	...
	public void removeByG_S(long groupId, int status) throws SystemException {
		for (Feedback feedback : findByG_S(groupId, status, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(feedback);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_S_STATUS_2 = "feedback.status = ?";
	...
	@Override
	public Feedback updateImpl(com.meera.db.model.Feedback feedback)
		throws SystemException {
		feedback = toUnwrappedModel(feedback);
		...
		if (isNew || !FeedbackModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((feedbackModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						feedbackModelImpl.getOriginalGroupId(),
						feedbackModelImpl.getOriginalStatus()
					};
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.meera.db.model.Feedback")));
