...
import com.meera.db.model.FeedbackModel;
...
/**
 * The base model implementation for the Feedback service. Represents a row in the &quot;feedback_Feedback&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.meera.db.model.FeedbackModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link FeedbackImpl}.
 * </p>
 *
 * @author E5410
 * @see FeedbackImpl
 * @see com.meera.db.model.Feedback
 * @see com.meera.db.model.FeedbackModel
 * @generated
 */
public class FeedbackModelImpl extends BaseModelImpl<Feedback>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a feedback model instance should use the {@link com.meera.db.model.Feedback} interface instead.
	 */
	public static final String TABLE_NAME = "feedback_Feedback";
	public static final Object[][] TABLE_COLUMNS = {
			{ "uuid_", Types.VARCHAR },
			{ "feedbackId", Types.BIGINT },
			{ "feedbackDate", Types.TIMESTAMP },
			{ "feedbackText", Types.CLOB },
	...
	public static final String TABLE_SQL_CREATE = "create table feedback_Feedback (uuid_ VARCHAR(75) null,feedbackId LONG not null primary key,feedbackDate DATE null,feedbackText TEXT null,feedbackSubject STRING null,status INTEGER,statusByUserId LONG,statusByUserName VARCHAR(75) null,statusDate DATE null,companyId LONG,groupId LONG,userId LONG)";
	public static final String TABLE_SQL_DROP = "drop table feedback_Feedback";
	public static final String ORDER_BY_JPQL = " ORDER BY feedback.feedbackId ASC, feedback.feedbackDate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY feedback_Feedback.feedbackId ASC, feedback_Feedback.feedbackDate DESC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.meera.db.model.Feedback"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.meera.db.model.Feedback"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.meera.db.model.Feedback"),
			true);
	public static long COMPANYID_COLUMN_BITMASK = 1L;
	public static long FEEDBACKTEXT_COLUMN_BITMASK = 2L;
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.meera.db.model.Feedback"));
	...
	public void resetOriginalValues() {
		...
		feedbackModelImpl._originalStatus = feedbackModelImpl._status;

		feedbackModelImpl._setOriginalStatus = false;
